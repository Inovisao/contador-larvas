...
3. Para informações detalhadas, consultar o artigo ```Contagem e detec¸c˜ao em imagens com alta densidade de larvas de peixes``` no repositório de artigos do INOVISÃO
